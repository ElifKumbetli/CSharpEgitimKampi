...
namespace _02_Veriables
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //Console.OutputEncoding = Encoding.UTF8; // UTF-8 çıktısını destekle
            ...
            //Console.WriteLine("-------------------");
            //Console.WriteLine("Yolcu TC Kimlik No: " +passengerIdentityNumber +  " Yolcu Ad Soyad: " + passengerName + " " + passengerSurname + " "+ passengerDistrict + 
